...
# 10% Copper (below 500), 32% 500mb, 35% 1Gig, 20% 2Gig = 97%
# Adjusting to 100%: Copper 10%, 500mb 32%, 1 Gig 35%, 2 Gig 23%
speed_categories = [
    'Copper',  # Below 500mb - 10%
    '500mb',   # 32%
    '1Gig',    # 35%
    '2Gig'     # 23% (adjusted to make 100%)
]
speed_probabilities = [0.10, 0.32, 0.35, 0.23]
...
# Foolproof Followers - 21%, Settled Simplifiers - 36% = 99%
# Adjusting Settled Simplifiers to 37% to make 100%
segments = [
